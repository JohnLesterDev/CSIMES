...
public class InventoryPanel {
	...
	*/
	public void setHotkeys() {
		...
		this.panel.getInputMap().put(KeyStroke.getKeyStroke("alt A"), "addPRDAction");
		this.panel.getActionMap().put("addPRDAction", new AbstractAction() {
